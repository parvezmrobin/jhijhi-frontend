...
export default class ChangePassword extends Component {
  ...
  onChange = (changedState) => {
    this.setState((prevState) => ({
      values: { ...prevState.values, ...changedState },
    }));
  };

  render() {
    const { values, isValid, feedback, message, showErrorModal } = this.state;
        ...
        <CenterContent col="col-xl-4 col-lg-6 col-md-8 col-sm-10">
          ...
          <form onSubmit={this.onSubmit}>
            ...
            <FormGroup
              name="new-password"
              type="password"
              onChange={(e) => this.onChange({ new: e.target.value })}
              value={values.new}
              isValid={isValid.new}
            ...
            <FormGroup
              name="confirm"
              type="password"
              onChange={(e) => this.onChange({ confirm: e.target.value })}
